...
- **Failed Post Condition**
  프로필 정보를 불러오지 못하면 화면에 정보가 표시되지 않는다.
#### MAIN SUCCESS SCENARIO
| Step | Action                                               |
| ---- | --------------------------------------------------------- |
...
- **Success Post Condition**
  변경된 프로필 정보가 정상적으로 저장된다.
- **Failed Post Condition**
  입력값이 유효하지 않거나 서버 오류가 발생하면 수정이 완료되지 않는다.
#### MAIN SUCCESS SCENARIO
| Step | Action                                               |
| ---- | --------------------------------------------------------- |
...
- **Success Post Condition**
  사용자는 본인 확인 후 새로운 비밀번호를 설정할 수 있다. 수 있다.
- **Failed Post Condition**
  본인 확인에 실패하면 비밀번호 재설정은 진행되지 않는다.
#### MAIN SUCCESS SCENARIO
| Step | Action                                               |
| ---- | --------------------------------------------------------- |
...
- **Primary Actor**
  Guest
- **Preconditions**
  사용자는 회원가입을 완료했거나 최초 로그인을 마친 상태여야 한다.
- **Trigger**
